...
public class QuorumPeer extends Thread implements QuorumStats.Provider {
    ...
    /*****************************************************************/
    String paneString = "10.100.0.1";
    int panePort = 4242;
    int paneResvSec = 3600;
            ...
            while (running) {
                ...
                case FOLLOWING:
                    try {
                        ...
                        /*****************************************************************/
                        QuorumServer me = this.quorumPeers.get(myid);
                        follower.setPaneInfo(paneString, panePort, me.addr.getAddress().getHostAddress(), 2888, 3888, 2181, paneResvSec);
                        follower.setRemainTime(remainingTime);
                        /*****************************************************************/
                        ...
                        /*****************************************************************/
                    	remainingTime = follower.getRemainTime();
                    	/*****************************************************************/
                        follower.shutdown();
                        setFollower(null);
                        setPeerState(ServerState.LOOKING);
                ...
                case LEADING:
                    ...
                    try {
                        ...
                        /*****************************************************************/
                        QuorumServer me = this.quorumPeers.get(myid);
                        leader.setPaneInfo(paneString, panePort, me.addr.getAddress().getHostAddress(), 2888, 3888, 2181, paneResvSec);
                        leader.setRemainTime(remainingTime);
                        /*****************************************************************/
                        leader.lead();
                        setLeader(null);
                    } catch (Exception e) {
                        ...
                        if (leader != null) {
                            /*****************************************************************/
                            remainingTime = leader.getRemainTime();
                            /*****************************************************************/
